...
class CreateSportsDota2CountryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sports_dota2_country', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sports_dota2_country');
    }
}
