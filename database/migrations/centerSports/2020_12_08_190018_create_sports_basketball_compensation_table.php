...
class CreateSportsBasketballCompensationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sports_basketball_compensation', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sports_basketball_compensation');
    }
}
