...
class CreateSportsFootballManagerTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sports_football_manager', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sports_football_manager');
    }
}
