...
class CreateSportsFootballMatchPlayerStatsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sports_football_match_player_stats', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sports_football_match_player_stats');
    }
}
