...
class CreateSportsBasketballMatchVideoCollectionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sports_basketball_match_video_collection', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sports_basketball_match_video_collection');
    }
}
