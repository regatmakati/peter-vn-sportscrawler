...
class CreateSportsFootballCountryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sports_football_country', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sports_football_country');
    }
}
