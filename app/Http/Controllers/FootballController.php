...
class FootballController extends Controller
{
    /**
     * @OA\Get(
     *      path="/api/v1/football/getMatchAllList",
     ...
     *              property="日期",
     *              type="array",
     *              @OA\Items(ref="#/components/schemas/足球比赛列表")
     *          ),
     *      )
     *   )
     *  ),
    ...
    public function getMatchAllList(Request $request)
    {
        ...
        $input = $request->input();
        $matchList = CmfSportsFootballMatchModel::getMatchAllList($input);
    ...
    /**
     * @OA\Get(
     *      path="/api/v1/football/getMatchPlayingList",
    ...
    public function getMatchPlayingList(Request $request)
    {
        ...
        $input = $request->input();
        $matchList = CmfSportsFootballMatchModel::getMatchPLayingList($input);
    ...
    /**
     * @OA\Get(
     *      path="/api/v1/football/getMatchListByDate",
    ...
    public function getMatchListByDate(Request $request)
    {
        ...
        $matchList = CmfSportsFootballMatchModel::getMatchListByDate($input);
     ...
     *          response=200,
     *          description="List posts",
     *          @OA\JsonContent(ref="#/components/schemas/足球比赛列表")
     *      )
     *  ),
     */
    public function getMatch(Request $request)
    {
        ...
        $input = $request->input();
        $matchList = CmfSportsFootballMatchModel::getMatch($input);
