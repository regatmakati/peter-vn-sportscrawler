...
class CreateCmfSportsFootballTeamTable extends Migration {
	...
	{
	    DB::statement("
            CREATE TABLE `cmf_sports_football_team` (
              ...
              PRIMARY KEY (`id`),
              UNIQUE KEY `unq_teamId` (`teamId`) USING BTREE
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='足球队伍表';
	    ");
	}
	...
	{
		Schema::drop('cmf_sports_football_team');
	}
