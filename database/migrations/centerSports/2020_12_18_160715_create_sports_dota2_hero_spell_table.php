...
class CreateSportsDota2HeroSpellTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sports_dota2_hero_spell', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sports_dota2_hero_spell');
    }
}
