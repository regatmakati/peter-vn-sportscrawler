...
class FootballV2Controller extends Controller
{
    /**
     * @OA\Get(
     *      path="/api/v2/football/getMatchAllList",
    ...
    public function getMatchAllList(Request $request)
    {
        ...
        $input = $request->input();
        $matchList = SportsFootballMatchModel::getMatchAllList($input);
    ...
    /**
     * @OA\Get(
     *      path="/api/v2/football/getMatchPlayingList",
    ...
    public function getMatchPlayingList(Request $request)
    {
        ...
        $input = $request->input();
        $matchList = SportsFootballMatchModel::getMatchPLayingList($input);
    ...
    /**
     * @OA\Get(
     *      path="/api/v2/football/getMatchListByDate",
    ...
    public function getMatchListByDate(Request $request)
    {
        ...
        $matchList = SportsFootballMatchModel::getMatchListByDate($input);
