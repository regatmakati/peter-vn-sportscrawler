...
class CreateSportsFootballSeasonTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sports_football_season', function (Blueprint $table) {
            $table->unsignedInteger('id')->primary();
            $table->unsignedInteger('competition_id')->index('idx_competition_id')->comment('赛事id');
            $table->unsignedInteger('competition_rule_id')->index('idx_competition_rule_id')->comment('赛制id');
            ...
            $table->boolean('has_table')->unsigned()->nullable()->comment('是否有积分榜，1-是、0-否');
    ...
    {
        Schema::dropIfExists('sports_football_season');
    }
}
