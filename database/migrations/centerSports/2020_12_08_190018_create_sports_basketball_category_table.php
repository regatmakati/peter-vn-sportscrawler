...
class CreateSportsBasketballCategoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sports_basketball_category', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sports_basketball_category');
    }
}
