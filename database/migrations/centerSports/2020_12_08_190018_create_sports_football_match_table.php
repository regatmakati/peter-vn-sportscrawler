...
class CreateSportsFootballMatchTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sports_football_match', function (Blueprint $table) {
            $table->unsignedInteger('id')->primary();
            $table->unsignedInteger('season_id')->index('idx_season_id')->comment('赛季d');
...
lineup: 是否有阵容，1-是、0-否');
            ...
            $table->unsignedInteger('referee_id')->nullable()->index('idx_referee_id')->comment('裁判id，没有不存在');
...
humidity:湿度');
    ...
    {
        Schema::dropIfExists('sports_football_match');
    }
}
