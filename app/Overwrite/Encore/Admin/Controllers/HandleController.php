...
class HandleController extends Controller
{
    ...
    public function handleAction(Request $request)
    {
        ...
        if ($response instanceof Response) {
            $_model = $request->get('_model');
            if ($request->get('_action') == 'Encore_Admin_Grid_Actions_Delete') {
                switch ($_model) {
                    case 'App_Models_OpCategoryModel':
                        OpCategoryModel::publish();
                        break;
                    case 'App_Models_OpLabelModel':
                        OpLabelModel::publish();
                        break;
                }
            }
