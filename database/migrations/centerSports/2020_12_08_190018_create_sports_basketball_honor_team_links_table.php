...
class CreateSportsBasketballHonorTeamLinksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sports_basketball_honor_team_links', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sports_basketball_honor_team_links');
    }
}
